...
namespace ADPasswordSecureCache.Policies
{
    /// <summary>
    ...
    public class LruCachePolicy<TKey> : ICachePolicy<TKey> where TKey : IEquatable<TKey>
    {
        /// <summary>
        ...
        public LruCachePolicy(IEqualityComparer<TKey> keyComparer = null)
        {
